...
const links=[["/overview","Overview"],["/timeline","Timeline"],["/history","History"],["/administrations","Administrations"],["/government-control","Government"],["/forecast","Forecast"],["/scenario","Scenario Lab"],["/methodology","Methodology"]];
