...
const links=[["/overview","Overview"],["/timeline","Timeline"],["/history","History"],["/administrations","Administrations"],["/forecast","Forecast"],["/scenario","Scenario Lab"],["/methodology","Methodology"]];
